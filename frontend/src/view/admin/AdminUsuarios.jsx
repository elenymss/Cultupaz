...
function AdminUsuarios() {
  ...
  //ver aprendices inactivos
  const [usuariosInactivo, setUsuariosInactivo] = useState([]);

  useEffect(() => {
    UsuariosAprendizInactivos();
  }, []);

  const UsuariosAprendizInactivos = async () => {
    try {
      const { data } = await axios.get(
        "http://localhost:7000/verAprendizInactivo"
      );
      setUsuariosInactivo(data);
    } catch (error) {
      console.log(error);
    }
  };
  ...
  //ver gestores inactivos
  const [gestorInactivo, setGestorInactivo] = useState([]);

  useEffect(() => {
    verUsuariosGestores();
  }, []);

  const verUsuariosGestores = async () => {
    try {
      const { data } = await axios.get(
        "http://localhost:7000/verGestoresInactivo"
      );
      setGestorInactivo(data);
    } catch (error) {
      console.log(error);
    }
  };
                ...
                <div className="row">
                  <section className="section">
                      ...
                      <div className="col-lg-12">
                        <div className="card">
                          <div className="card-body usuario">
                            <h5 className="card-title card-bg text-center">
                              Aprendices activos
                            </h5>
                    ...
                    <div className="row">
                      <div className="col-lg-12">
                        <div className="card">
                          <div className="card-body usuarioInac">
                            <h5 className="card-title card-bg text-center">
